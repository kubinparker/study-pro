...
return [
    ...
    'App' => [
        ...
        'paths' => [
            ...
            // 'plugins' => [ROOT . DS . 'templates' . DS . 'themed' . DS],
            'templates' => [ROOT . DS . 'templates' . DS],
            'locales' => [RESOURCES . 'locales' . DS],
        ],
        // convert obj Upload File to array
    ...
    'Email' => [
        ...
        'contact_local' => [
            'transport' => 'default',
            'from' => 'test+form@caters.co.jp',
            // 'emailFormat' => 'text',
            'to' => ['test+to@caters.co.jp','takimoto@caters.co.jp'],
            'subject' => 'Test class send mail of Cakephp 4.x',
